...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=[42],
        help="Random seeds used for independent Double Q-learning runs.",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help="Override TrainingConfig.alpha for Double Q-learning.",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="Double Q-learning discount factor.",
    )

    parser.add_argument(
        "--output-dir",
        type=str,
        default="results/training_runs/double_q_learning",
        help=(
            "Root directory where Double Q-learning models are saved. "
    ...
    parser.add_argument(
        ...
        default=True,
        help="Enable Double Q-learning model checkpoints.",
    )
...
def run_double_q_learning_training(
    *,
    episodes: int,
    seeds: Sequence[int],
    models: Sequence[str],
    ...
    print(
        "Double Q-learning training suite finished\n"
        f"episodes={episodes}\n"
        f"seeds={list(seeds)}\n"
...
if __name__ == "__main__":
    ...
    run_double_q_learning_training(
