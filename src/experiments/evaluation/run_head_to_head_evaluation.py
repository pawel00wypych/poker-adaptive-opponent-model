...
def main() -> None:
    ...
    print(
        ...
        f"training_episodes="
        f"{sorted({bundle.episode for bundle in bundles}) or 'not_applicable'}\n"
        f"model_seeds="
        f"{args.seeds or ('auto' if learned_agents else 'not_applicable')}\n"
        f"evaluation_replicates="
        f"{args.evaluation_replicates if baseline_agents else 'not_applicable'}\n"
