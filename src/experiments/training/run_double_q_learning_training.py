...
from src.training.double_q_learning_trainer import (
    ...
    DOUBLE_Q_LEARNING_DISPLAY_NAME,
    model_run_name,
    run_double_q_learning_model_training,
)

DOUBLE_Q_LEARNING_CLI_SPEC = TDTrainingCliSpec(
    algorithm_name=DOUBLE_Q_LEARNING_ALGORITHM_NAME,
    display_name=DOUBLE_Q_LEARNING_DISPLAY_NAME,
    default_output_dir="results/training_runs/double_q_learning",
    trainer_function=run_double_q_learning_model_training,
    model_run_name_function=model_run_name,
)


def parse_args():
    return parse_td_training_args(DOUBLE_Q_LEARNING_CLI_SPEC)
...
def run_double_q_learning_training(
    *,
    ...
    return run_td_training(
        spec=DOUBLE_Q_LEARNING_CLI_SPEC,
        episodes=episodes,
        seeds=seeds,
        models=models,
...
if __name__ == "__main__":
    run_td_cli(DOUBLE_Q_LEARNING_CLI_SPEC)
