...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=[42],
        help="Random seeds used for independent SARSA runs.",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=None,
        help="Override TrainingConfig.alpha for SARSA.",
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="SARSA discount factor.",
    )

    parser.add_argument(
        "--output-dir",
        type=str,
        default="results/training_runs/sarsa",
        help=(
            "Root directory where SARSA models are saved. "
    ...
    parser.add_argument(
        ...
        default=True,
        help="Enable SARSA model checkpoints.",
    )
