...
def model_run_name(model_type: str) -> str:
    ...
    raise ValueError(
        f"Unsupported Double Q-learning model type: {model_type}"
    )


def default_model_path(model_type: str) -> str:
    return str(
        Path("results/models/double_q_learning")
...
def build_double_q_learning_metadata(
    *,
    model_type: str,
    opponent_type: str,
    ...
    metadata = {
        "algorithm": DOUBLE_Q_LEARNING_ALGORITHM_NAME,
    ...
    *,
    ...
    if model_type in TRAINING_OPPONENT_TYPES:
        return SpecialistPolicyPlayer(
            ...
            player_name="specialist_double_q_learning",
            verbose=player_verbose,
            log_interval=player_log_interval,
        )
...
def run_double_q_learning_model_training(
    *,
    model_type: str,
    ...
    for episode_index in range(total_episodes):
        ...
        if (
            ...
            print(
                f"Double Q-learning {model_type}: "
        ...
        if (
            ...
            if progress:
                print(
                    "Saved Double Q-learning checkpoint: "
                    f"{checkpoint_path}"
                )
    ...
    print(
        "Double Q-learning training finished\n"
