METRIC_DESCRIPTIONS = {
    ...
    "mean_profit_bb_std_across_seeds": "Sample standard deviation of per-seed mean profit across independent training seeds.",
    "mean_profit_bb_standard_error_across_seeds": "Standard error of mean_profit_bb calculated from equally weighted training-seed means.",
    "mean_profit_bb_ci_95_lower_across_seeds": "Lower bound of the 95% Student-t confidence interval across training seeds.",
    "mean_profit_bb_ci_95_upper_across_seeds": "Upper bound of the 95% Student-t confidence interval across training seeds.",
    "mean_profit_bb_ci_95_margin_across_seeds": "Margin of error of the 95% Student-t confidence interval across training seeds.",
    "mean_profit_bb_min_across_seeds": "Lowest per-seed mean profit in the aggregated group.",
    "mean_profit_bb_max_across_seeds": "Highest per-seed mean profit in the aggregated group.",
    "mean_profit_bb_seed_spread": "Difference between the highest and lowest per-seed mean profit.",
