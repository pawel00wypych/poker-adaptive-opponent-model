...
POLICY_GENERAL_AGENT = "policy_general"
...
CROSS_POLICY_AGENT_TO_POLICY_TYPE = {
    POLICY_GENERAL_AGENT: UNKNOWN_POLICY,
...
AGENT_DISPLAY_NAMES = {
    ...
    POLICY_GENERAL_AGENT: "Fixed general policy",
...
AGENT_TO_ORACLE_AGENT = {
    SINGLE_POLICY_MC_AGENT: ORACLE_MC_AGENT,
    ADAPTIVE_MC_AGENT: ORACLE_MC_AGENT,
    ORACLE_MC_AGENT: ORACLE_MC_AGENT,
    POLICY_GENERAL_AGENT: ORACLE_MC_AGENT,
