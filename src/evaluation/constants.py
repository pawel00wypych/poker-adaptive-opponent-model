...
AGENT_TO_ORACLE_AGENT = {
    ...
    POLICY_GENERAL_MC_AGENT: ORACLE_MC_AGENT,
    POLICY_TIGHT_AGENT: ORACLE_MC_AGENT,
    POLICY_AGGRESSIVE_AGENT: ORACLE_MC_AGENT,
    POLICY_CALLING_AGENT: ORACLE_MC_AGENT,
    ADAPTIVE_Q_LEARNING_AGENT: ORACLE_Q_LEARNING_AGENT,
    ORACLE_Q_LEARNING_AGENT: ORACLE_Q_LEARNING_AGENT,
    POLICY_GENERAL_Q_LEARNING_AGENT: ORACLE_Q_LEARNING_AGENT,
    POLICY_TIGHT_Q_LEARNING_AGENT: ORACLE_Q_LEARNING_AGENT,
    POLICY_AGGRESSIVE_Q_LEARNING_AGENT: ORACLE_Q_LEARNING_AGENT,
    POLICY_CALLING_Q_LEARNING_AGENT: ORACLE_Q_LEARNING_AGENT,
    ADAPTIVE_SARSA_AGENT: ORACLE_SARSA_AGENT,
    ORACLE_SARSA_AGENT: ORACLE_SARSA_AGENT,
    POLICY_GENERAL_SARSA_AGENT: ORACLE_SARSA_AGENT,
    POLICY_TIGHT_SARSA_AGENT: ORACLE_SARSA_AGENT,
    POLICY_AGGRESSIVE_SARSA_AGENT: ORACLE_SARSA_AGENT,
    POLICY_CALLING_SARSA_AGENT: ORACLE_SARSA_AGENT,
    ADAPTIVE_DOUBLE_Q_LEARNING_AGENT: ORACLE_DOUBLE_Q_LEARNING_AGENT,
    ORACLE_DOUBLE_Q_LEARNING_AGENT: ORACLE_DOUBLE_Q_LEARNING_AGENT,
    POLICY_GENERAL_DOUBLE_Q_LEARNING_AGENT: ORACLE_DOUBLE_Q_LEARNING_AGENT,
    POLICY_TIGHT_DOUBLE_Q_LEARNING_AGENT: ORACLE_DOUBLE_Q_LEARNING_AGENT,
    POLICY_AGGRESSIVE_DOUBLE_Q_LEARNING_AGENT: ORACLE_DOUBLE_Q_LEARNING_AGENT,
    POLICY_CALLING_DOUBLE_Q_LEARNING_AGENT: ORACLE_DOUBLE_Q_LEARNING_AGENT,
}
