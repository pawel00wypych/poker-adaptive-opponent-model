...
AGENT_TO_ORACLE_AGENT = {
    ...
    POLICY_UNKNOWN_AGENT: ORACLE_MC_AGENT,
    POLICY_UNKNOWN_MC_AGENT: ORACLE_MC_AGENT,
    ...
    POLICY_UNKNOWN_Q_LEARNING_AGENT: ORACLE_Q_LEARNING_AGENT,
    ADAPTIVE_SARSA_AGENT: ORACLE_SARSA_AGENT,
    ORACLE_SARSA_AGENT: ORACLE_SARSA_AGENT,
    POLICY_UNKNOWN_SARSA_AGENT: ORACLE_SARSA_AGENT,
    ADAPTIVE_DOUBLE_Q_LEARNING_AGENT: ORACLE_DOUBLE_Q_LEARNING_AGENT,
    ORACLE_DOUBLE_Q_LEARNING_AGENT: ORACLE_DOUBLE_Q_LEARNING_AGENT,
    POLICY_UNKNOWN_DOUBLE_Q_LEARNING_AGENT: ORACLE_DOUBLE_Q_LEARNING_AGENT,
}
