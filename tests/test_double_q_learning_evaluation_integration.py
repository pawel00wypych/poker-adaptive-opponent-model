...
def test_build_model_bundle_includes_double_q_learning_paths(tmp_path):
...
def test_build_double_q_learning_general_policy_player(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "src.evaluation.checkpoint_evaluator.load_double_q_learning_eval_agent",
...
def test_build_double_q_learning_adaptive_player(tmp_path, monkeypatch):
    monkeypatch.setattr(
        "src.evaluation.checkpoint_evaluator.load_double_q_learning_adaptive_agents",
...
def test_build_generalization_double_q_learning_adaptive_uses_base_family(
    ...
    monkeypatch.setattr(
        "src.evaluation.generalization_evaluator.load_double_q_learning_adaptive_agents",
        lambda bundle: dummy_agents(),
    )
...
def test_build_generalization_double_q_learning_general_policy(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "src.evaluation.generalization_evaluator.load_double_q_learning_eval_agent",
        fake_load_double_q_learning_eval_agent,
    )
...
def test_checkpoint_cli_accepts_double_q_learning_run_dir():
...
def test_experiment_summary_accepts_double_q_learning_rows(tmp_path):
    ...
    assert any(
        row["agent_name"] == ADAPTIVE_DOUBLE_Q_LEARNING_AGENT
